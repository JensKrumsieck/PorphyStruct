...
namespace PorphyStruct.Simulations
{
    ...
    public static class Displacements
    {
        ...
        /// <summary>
        /// returns the DisplacementMatrix.
        /// </summary>
        ...
        public static Matrix<double> DisplacementMatrix(Macrocycle.Type type, int size)
        {
            ...
            if (type == Macrocycle.Type.Corrole)
                D = M.DenseOfColumnVectors(DomingCorrole, RufflingCorrole, SaddlingCorrole, Waving2aCorrole, Waving2bCorrole, PropelleringCorrole);
            else if (type == Macrocycle.Type.Porphyrin)
                D = M.DenseOfColumnVectors(DomingPorphyrin, RufflingPorphyrin, SaddlingPorphyrin, Waving1aPorphyrin, Waving1bPorphyrin, Waving2aPorphyrin, Waving2bPorphyrin, PropelleringPorphyrin);
            else if (type == Macrocycle.Type.Norcorrole)
                D = M.DenseOfColumnVectors(DomingNorcorrole, RufflingNorcorrole, SaddlingNorcorrole, Waving2aNorcorrole, Waving2bNorcorrole, PropelleringNorcorrole);
