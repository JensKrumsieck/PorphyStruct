...
---
			...
			<h4>
				8. Data protection provisions about the application and use of Swetrix Analytics
			</h4>
			<p>
				On this website, the controller has integrated the component of Swetrix Analytics. 
				Swetrix Analytics is a web analytics service. Web analytics is the
			...
			<p>
				The operator of the Swetrix Analytics component is the siteowner himself. The analytics service
				is hosted at <a href="https://analytics.jenskrumsieck.de" target="_blank">https://analytics.jenskrumsieck.de</a>
			</p>
			<p>Privacy Statement (German): <a href="https://jenskrumsieck.de/privacy" target="_blank">https://jenskrumsieck.de/privacy</a></p>
			...
			<ul>
				<li>Swetrix does not use cookies</li>
				<li>IP addresses are not stored (only temporarily hashed for up to 30 minutes)</li>
				<li>All data is fully anonymised</li>
