...
[The simulation procedure is described here.](/docs/concepts/simulation-method) [The use of the minimal and extended basis is shown here.](/docs/analysis/minimal-and-extended-basis)
