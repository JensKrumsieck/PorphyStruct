	...
	<div class="text-white">
		...
		<div class="grid grid-cols-3 space-y-2 items-stretch mt-12">
			<div>
				...
				<ul>
					<li><a href="/docs/getting-started">Introduction</a></li>
					<li><a href="/docs/getting-started/download-and-installation">Download & Installation</a></li>
					<li><a href="/docs/getting-started/user-interface">User Inferface</a></li>
				</ul>
			</div>
			<div>
				<h4>Concepts</h4>
				<ul>
					<li><a href="/docs/concepts/displacement-diagrams">Displacement Diagrams</a></li>
					<li><a href="/docs/concepts/modes">Modes</a></li>
					<li><a href="/docs/concepts/simulation-method">Simulation Method</a></li>
				</ul>
			</div>
			<div>
				<h4>Analysis</h4>
				<ul>
					<li><a href="/docs/analysis/simple-analysis">Simple Analysis</a></li>
					<li><a href="/docs/analysis/minimal-and-extended-basis">Minimal and Extended Basis</a></li>
					<li><a href="/docs/analysis/data-interpretation">Data Interpretation</a></li>
					<li><a href="/docs/analysis/export-plots-and-data">Export Plots and Data</a></li>
				</ul>
			</div>
			<div>
				<h4>Advanced Topics</h4>
				<ul>
					<li><a href="/docs/advanced/batch-processing">Batch Processing</a></li>
					<li><a href="/docs/advanced/comparisons">Comparisons</a></li>
					<li><a href="/docs/advanced/quick-settings">Customization - Quick Settings</a></li>
					<li><a href="/docs/advanced/structure-isolation">Structure Isolation</a></li>
					<li><a href="/docs/advanced/troubleshooting-hints">Troubleshooting & Hints</a></li>
				</ul>
			</div>
			<div>
				<h4>Settings</h4>
				<ul>
					<li><a href="/docs/settings/settings-data-color">Data & Color</a></li>
					<li><a href="/docs/settings/settings-export-update">Export & Update</a></li>
					<li><a href="/docs/settings/settings-graph">Graph</a></li>
				</ul>
			</div>
		</div>
	</div>
